...
- **Incremental & Delta Crawling**: Smart crawling that only processes new or changed content (95%+ faster updates)
...
The system now supports intelligent incremental crawling that dramatically reduces update times:
...
- **95%+ Faster**: Updates that took 30 minutes now complete in seconds
- **Automatic**: No configuration needed - works out of the box

Example performance:
- **GitHub Docs**: 1,838 pages - Initial: 25 min → Updates: 30 sec
- **React Docs**: 68 pages - Initial: 2 min → Updates: 3 sec

[See detailed documentation](docs/INCREMENTAL_CRAWLING.md)
