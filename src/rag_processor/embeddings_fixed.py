"""Embedding generation service with rate limiting"""
...
class EmbeddingService:
    """Service for generating text embeddings with rate limiting"""
    ...
    def __init__(self):
        ...
        # Rate limiter - 90 requests per minute to be safe
