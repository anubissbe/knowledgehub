...
class SearchService:
    ...
    async def _record_search_analytics(self, db: Session, query: SearchQuery, response: Dict[str, Any]):
        """Record search analytics for performance monitoring and insights.
        
        This method records search query metadata to the search_history
